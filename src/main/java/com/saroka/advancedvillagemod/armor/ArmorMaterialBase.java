...
public enum ArmorMaterialBase implements IArmorMaterial {

    CAST_IRON_CHAIN("cast_iron_chain", 27, new int[]{3, 7, 5, 3}, 9, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 0.0F, () -> {
        return Ingredient.fromItems(RegistryHandler.CAST_IRON_CHAIN_BAR.get());
    });
    ...
    ArmorMaterialBase(String name, int maxDamageFactor, int[] damageReductionAmountArray, int enchantability,
